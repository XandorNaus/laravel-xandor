...
@section('content')
    ...
    <div class="w-full py-56 shadow-2xl px-34 bg-cover bg-no-repeat bg-center relative z-30" style="background-image: url('https://images.pexels.com/photos/3183183/pexels-photo-3183183.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260');">
    ...
    <div id="products">
        <h1 class="text-3xl font-bold title-font mt-10 text-pink mb-7 text-center">Nieuws</h1>
        ...
        @foreach($products as $product)
            ...
            <div class="w-1/3 text 1-xltext-pink bg-white rounded">
                ...
                <x-product title="{{ $product->title }}" class="p-8 text-pink text-1xl font-medium " price="{!! $product->price_formatted !!}">
